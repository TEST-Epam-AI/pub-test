...
users = [
    {"id": 1, "username": "admin", "password": generate_password_hash("password123")},
    {"id": 2, "username": "user", "password": generate_password_hash("123456")},
]
...
def register():
    ...
    if request.method == "POST":
        ...
        new_user = {"id": len(users) + 1, "username": new_username, "password": generate_password_hash(new_password)}
